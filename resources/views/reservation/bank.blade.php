...
<head>
    ...
    <title>Bank Payment - City Public Cemetery</title>
...
<body>
    ...
    <div class="main-container">
        <h2>Send Payment via BPI</h2>
  
    <p style="text-align:center; margin-top:1em;">
        <img src="{{ asset('assests/bpi.jpg') }}" alt="Gcash QR Code" style="max-width:200px; width:100%; border-radius:10px; box-shadow:0 4px 8px rgba(0,0,0,0.2);">
    </p>
